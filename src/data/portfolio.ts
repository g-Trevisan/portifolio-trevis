...
import type { ContactLink, NavSection, Project, SectionId, SkillGroup, ThemeOption } from '@/types/portfolio'

export const ACCENT_COLOR = '#34d399'
export const WHATSAPP_URL = 'https://wa.me/5554996006674'
export const SECTION_IDS = ['inicio', 'sobre', 'projetos', 'skills', 'contato'] satisfies SectionId[]
