...
export function Hero() {
  return (
    <section id="inicio" className="relative overflow-hidden py-[176px] pb-[120px] max-[760px]:py-[136px] max-[760px]:pb-[88px]" data-screen-label="Hero">
      <div
      ...
      <div className={cn(sectionShell, 'relative flex flex-col items-start gap-7')}>
        <h1 className="m-0 max-w-[900px] text-[76px] font-bold leading-[1.05] tracking-normal text-balance max-[900px]:text-[58px] max-[480px]:text-[42px]">
        ...
        <div className="mt-5 flex flex-wrap items-center gap-x-6 gap-y-2.5 font-mono text-[13px] text-[var(--muted3)]" aria-label="Tecnologias principais">
